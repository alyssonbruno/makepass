...
def read_lang_file(lang: str = DEFAULT_LANG) -> list[str]:
    ...
    try:
        ...
        raise LangNotFound(f"File {lang} not found")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--count", type=int, help=f"Number of words, default is {DEFAULT_COUNT}", required=False,
                        default=DEFAULT_COUNT)
    parser.add_argument("-l", "--lang", type=str, help=f"Language, default is {DEFAULT_LANG}", required=False,
